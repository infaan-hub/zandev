      ...
      <div className="flex items-center justify-center" style={{ minHeight: 'calc(100vh - 250px)' }}>
        <div className="w-full max-w-[400px]">
          ...
          <div className="p-[28px] rounded-[18px] border border-white/[0.10] bg-gradient-to-br from-white/[0.035] to-white/[0.008]">
            <button className="w-full h-[40px] rounded-[8px] border border-white/[0.10] bg-white text-black text-[11px] font-semibold flex items-center justify-center gap-[8px] hover:-translate-y-[2px] transition-transform duration-200">
              <GoogleIcon />
              Continue with Google
            </button>

            <button className="w-full h-[40px] mt-[8px] rounded-[8px] border border-white/[0.10] bg-[#24292e] text-white text-[11px] font-semibold flex items-center justify-center gap-[8px] hover:-translate-y-[2px] transition-transform duration-200">
